...
public class FourToSevenInternalFrame extends javax.swing.JInternalFrame {

    int nepaliTh, englishTh, mathTh, scienceTh, localTh, socialTh, healthTh;
    int nepaliPr, englishPr, mathPr, sciencePr, localPr, socialPr, healthPr;
    
    double nepaliGPPR, englishGPPR, mathGPPR, scienceGPPR, localGPPR, socialGPPR, healthGPPR;
    double nepaliGPTH, englishGPTH, mathGPTH, scienceGPTH, localGPTH, socialGPTH, healthGPTH;
    double nepaliGP, englishGP, mathGP, scienceGP, localGP, socialGP, healthGP;
    
    double GPA;
    String totalGrade;
    String remark;
    
    public FourToSevenInternalFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel70.setForeground(new java.awt.Color(255, 255, 51));
        jLabel70.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        jLabel71.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel71.setForeground(new java.awt.Color(255, 255, 51));
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
       try{
            ...
            socialTh = Integer.parseInt(jTextField3.getText());
            scienceTh = Integer.parseInt(jTextField4.getText());
            healthTh = Integer.parseInt(jTextField13.getText());
            ...
            socialPr = Integer.parseInt(jTextField7.getText());
            sciencePr = Integer.parseInt(jTextField8.getText());
            healthPr = Integer.parseInt(jTextField14.getText());
            ...
            socialGPPR = ((double)socialPr / 50) * 100;
            scienceGPPR = ((double)sciencePr / 50) * 100;
            healthGPPR = ((double)healthPr / 50) * 100;
        ...
        //For social subject
        if(socialGPPR>=90 && socialGPPR<=100){
            jLabel23.setText("4.0");
            jLabel29.setText("A+");
        }
        else if(socialGPPR>=80 && socialGPPR<90){
            jLabel23.setText("3.6");
            jLabel29.setText("A");
        }
        else if(socialGPPR>=70 && socialGPPR<80){
            jLabel23.setText("3.2");
            jLabel29.setText("B+");
        }
        else if(socialGPPR>=60 && socialGPPR<70){
            jLabel23.setText("2.8");
            jLabel29.setText("B");
        }
        else if(socialGPPR>=50 && socialGPPR<60){
            jLabel23.setText("2.4");
            jLabel29.setText("C+");
        }
        else if(socialGPPR>=40 && socialGPPR<50){
            jLabel23.setText("2.0");
            jLabel29.setText("C");
        }
        else if(socialGPPR>=35 && socialGPPR<40){
        ...
        //For health subject
        if(healthGPPR>=90 && healthGPPR<=100){
            jLabel66.setText("4.0");
            jLabel67.setText("A+");
        }
        else if(healthGPPR>=80 && healthGPPR<90){
            jLabel66.setText("3.6");
            jLabel67.setText("A");
        }
        else if(healthGPPR>=70 && healthGPPR<80){
            jLabel66.setText("3.2");
            jLabel67.setText("B+");
        }
        else if(healthGPPR>=60 && healthGPPR<70){
            jLabel66.setText("2.8");
            jLabel67.setText("B");
        }
        else if(healthGPPR>=50 && healthGPPR<60){
            jLabel66.setText("2.4");
            jLabel67.setText("C+");
        }
        else if(healthGPPR>=40 && healthGPPR<50){
            jLabel66.setText("2.0");
            jLabel67.setText("C");
        }
        else if(healthGPPR>=35 && healthGPPR<40){
            jLabel66.setText("1.6");
            jLabel67.setText("D");
        }
        else{
           jLabel66.setText("-");
        ...
        //GP calculation of written evaluation of each subject
            ...
            socialGPTH = ((double)socialTh / 50) * 100;
            scienceGPTH = ((double)scienceTh / 50) * 100;
            healthGPTH = ((double)healthTh / 50) * 100;
        ...
        //For social subject
        if(socialGPTH>=90 && socialGPTH<=100){
            jLabel41.setText("4.0");
            jLabel42.setText("A+");
        }
        else if(socialGPTH>=80 && socialGPTH<90){
            jLabel41.setText("3.6");
            jLabel42.setText("A");
        }
        else if(socialGPTH>=70 && socialGPTH<80){
            jLabel41.setText("3.2");
            jLabel42.setText("B+");
        }
        else if(socialGPTH>=60 && socialGPTH<70){
            jLabel41.setText("2.8");
            jLabel42.setText("B");
        }
        else if(socialGPTH>=50 && socialGPTH<60){
            jLabel41.setText("2.4");
            jLabel42.setText("C+");
        }
        else if(socialGPTH>=40 && socialGPTH<50){
            jLabel41.setText("2.0");
            jLabel42.setText("C");
        }
        else if(socialGPTH>=35 && socialGPTH<40){
        ...
        //For health subject
        if(healthGPTH>=90 && healthGPTH<=100){
            jLabel68.setText("4.0");
            jLabel69.setText("A+");
        }
        else if(healthGPTH>=80 && healthGPTH<90){
            jLabel68.setText("3.6");
            jLabel69.setText("A");
        }
        else if(healthGPTH>=70 && healthGPTH<80){
            jLabel68.setText("3.2");
            jLabel69.setText("B+");
        }
        else if(healthGPTH>=60 && healthGPTH<70){
            jLabel68.setText("2.8");
            jLabel69.setText("B");
        }
        else if(healthGPTH>=50 && healthGPTH<60){
            jLabel68.setText("2.4");
            jLabel69.setText("C+");
        }
        else if(healthGPTH>=40 && healthGPTH<50){
            jLabel68.setText("2.0");
            jLabel69.setText("C");
        }
        else if(healthGPTH>=35 && healthGPTH<40){
            jLabel68.setText("1.6");
            jLabel69.setText("D");
        }
        else{
           jLabel68.setText("-");
        ...
        socialGP = (Double.parseDouble(jLabel23.getText()) * 0.5) + (Double.parseDouble(jLabel41.getText()) * 0.5);
        scienceGP = (Double.parseDouble(jLabel24.getText()) * 0.5) + (Double.parseDouble(jLabel43.getText()) * 0.5);
        healthGP = (Double.parseDouble(jLabel66.getText()) * 0.5) + (Double.parseDouble(jLabel68.getText()) * 0.5);
        ...
        else if(socialGP>=3.6 && socialGP<4.0){
            jLabel54.setText("A");
            jLabel55.setText("3.6");
        }
        else if(socialGP>=3.2 && socialGP<3.6){
            jLabel54.setText("B+");
            jLabel55.setText("3.2");
        }
        else if(socialGP>=2.8 && socialGP<3.2){
            jLabel54.setText("B");
            jLabel55.setText("2.8");
        }
        else if(socialGP>=2.4 && socialGP<2.8){
            jLabel54.setText("C+");
            jLabel55.setText("2.4");
        }
        else if(socialGP>=2.0 && socialGP<2.4){
            jLabel54.setText("C");
            jLabel55.setText("2.0");
        }
        else if(socialGP>=1.6 && socialGP<2.0){
            jLabel54.setText("D");
        ...
        if(healthGP==4.0){
            jLabel71.setText("A+");
            jLabel70.setText("4.0");
        }
        else if(healthGP>=3.6 && healthGP<4.0){
            jLabel71.setText("A");
            jLabel70.setText("3.6");
        }
        else if(healthGP>=3.2 && healthGP<3.6){
            jLabel71.setText("B+");
            jLabel70.setText("3.2");
        }
        else if(healthGP>=2.8 && healthGP<3.2){
            jLabel71.setText("B");
            jLabel70.setText("2.8");
        }
        else if(healthGP>=2.4 && healthGP<2.8){
            jLabel71.setText("C+");
            jLabel70.setText("2.4");
        }
        else if(healthGP>=2.0 && healthGP<2.4){
            jLabel71.setText("C");
            jLabel70.setText("2.0");
        }
        else if(healthGP>=1.6 && healthGP<2.0){
            jLabel71.setText("D");
            jLabel70.setText("1.6");
        }
        else{
            jLabel71.setText("NG");
            jLabel70.setText("-");
        ...
        //calculating GPA
        GPA = ((Double.parseDouble(jLabel45.getText()) * 5) + (Double.parseDouble(jLabel47.getText()) * 5) + (Double.parseDouble(jLabel49.getText()) * 5) + (Double.parseDouble(jLabel51.getText()) * 4) + (Double.parseDouble(jLabel55.getText()) * 5) + (Double.parseDouble(jLabel53.getText()) * 5) + (Double.parseDouble(jLabel70.getText()) * 3)) / 32;
