...
public class LKGUKGInternalFrame extends javax.swing.JInternalFrame {

    int nepaliTh, englishTh, mathTh, scienceTh, socialTh, gkTh;
    int nepaliPr, englishPr, mathPr, sciencePr, socialPr, gkPr;
    
    double nepaliGPPR, englishGPPR, mathGPPR, scienceGPPR, socialGPPR, gkGPPR;
    double nepaliGPTH, englishGPTH, mathGPTH, scienceGPTH, socialGPTH, gkGPTH;
    double nepaliGP, englishGP, mathGP, scienceGP, socialGP, gkGP;
    
    double GPA;
    String totalGrade;
    String remark;
    
    public LKGUKGInternalFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel65, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
        );
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
       try{
            ...
            scienceTh = Integer.parseInt(jTextField2.getText());
            socialTh = Integer.parseInt(jTextField3.getText());
            gkTh = Integer.parseInt(jTextField4.getText());
            ...
            sciencePr = Integer.parseInt(jTextField6.getText());
            socialPr = Integer.parseInt(jTextField7.getText());
            gkPr = Integer.parseInt(jTextField8.getText());
        ...
        //For gk subject
        if(gkGPPR>=90 && gkGPPR<=100){
            jLabel24.setText("4.0");
            jLabel32.setText("A+");
        }
        else if(gkGPPR>=80 && gkGPPR<90){
            jLabel24.setText("3.6");
            jLabel32.setText("A");
        }
        else if(gkGPPR>=70 && gkGPPR<80){
            jLabel24.setText("3.2");
            jLabel32.setText("B+");
        }
        else if(gkGPPR>=60 && gkGPPR<70){
            jLabel24.setText("2.8");
            jLabel32.setText("B");
        }
        else if(gkGPPR>=50 && gkGPPR<60){
            jLabel24.setText("2.4");
            jLabel32.setText("C+");
        }
        else if(gkGPPR>=40 && gkGPPR<50){
            jLabel24.setText("2.0");
            jLabel32.setText("C");
        }
        else if(gkGPPR>=35 && gkGPPR<40){
        ...
        //For gk subject
        if(gkGPTH>=90 && gkGPTH<=100){
            jLabel43.setText("4.0");
            jLabel44.setText("A+");
        }
        else if(gkGPTH>=80 && gkGPTH<90){
            jLabel43.setText("3.6");
            jLabel44.setText("A");
        }
        else if(gkGPTH>=70 && gkGPTH<80){
            jLabel43.setText("3.2");
            jLabel44.setText("B+");
        }
        else if(gkGPTH>=60 && gkGPTH<70){
            jLabel43.setText("2.8");
            jLabel44.setText("B");
        }
        else if(gkGPTH>=50 && gkGPTH<60){
            jLabel43.setText("2.4");
            jLabel44.setText("C+");
        }
        else if(gkGPTH>=40 && gkGPTH<50){
            jLabel43.setText("2.0");
            jLabel44.setText("C");
        }
        else if(gkGPTH>=35 && gkGPTH<40){
        ...
        scienceGP = (Double.parseDouble(jLabel22.getText()) * 0.5) + (Double.parseDouble(jLabel39.getText()) * 0.5);
        socialGP = (Double.parseDouble(jLabel23.getText()) * 0.5) + (Double.parseDouble(jLabel41.getText()) * 0.5);
        gkGP = (Double.parseDouble(jLabel24.getText()) * 0.5) + (Double.parseDouble(jLabel43.getText()) * 0.5);
        ...
        else if(gkGP>=3.6 && gkGP<4.0){
            jLabel56.setText("A");
            jLabel53.setText("3.6");
        }
        else if(gkGP>=3.2 && gkGP<3.6){
            jLabel56.setText("B+");
            jLabel53.setText("3.2");
        }
        else if(gkGP>=2.8 && gkGP<3.2){
            jLabel56.setText("B");
            jLabel53.setText("2.8");
        }
        else if(gkGP>=2.4 && gkGP<2.8){
            jLabel56.setText("C+");
            jLabel53.setText("2.4");
        }
        else if(gkGP>=2.0 && gkGP<2.4){
            jLabel56.setText("C");
            jLabel53.setText("2.0");
        }
        else if(gkGP>=1.6 && gkGP<2.0){
            jLabel56.setText("D");
        ...
        //calculating GPA
        GPA = ((Double.parseDouble(jLabel45.getText()) * 5) + (Double.parseDouble(jLabel47.getText()) * 5) + (Double.parseDouble(jLabel49.getText()) * 5) + (Double.parseDouble(jLabel51.getText()) * 5) + (Double.parseDouble(jLabel55.getText()) * 3) + (Double.parseDouble(jLabel53.getText()) * 3)) / 26;
